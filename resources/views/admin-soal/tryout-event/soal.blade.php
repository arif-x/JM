                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="importForm" method="POST" name="importForm" class="form-horizontal" action="{{ route('admin-soal.event-tryout.import') }}" enctype="multipart/form-data">
                                        @csrf
                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            var table = $('#dataTableExample').DataTable({
                                ...
                                serverSide: true,
                                paging: true,
                                ajax: "{{ route('admin-soal.event-tryout.soal.index') }}",
                                columns: [
                            ...
                            $('body').on('click', '.edit-data', function () {
                                ...
                                $.get("{{ route('admin-soal.event-tryout.soal.index') }}" +'/' + id_soal_tryout_event + '', function (data) {
                            ...
                            $('#saveBtn').click(function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ route('admin-soal.event-tryout.soal.store') }}",
                                    type: "POST",
                                    dataType: 'json',
                            ...
                            $('#saveDeteleBtn').click(function (e) {
                                ...
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('admin-soal.event-tryout.soal.store') }}"+'/'+id_soal_tryout_event,
                                    success: function (data) {
                                        table.draw();
