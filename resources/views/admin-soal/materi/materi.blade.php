                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            var table = $('#dataTableExample').DataTable({
                                ...
                                serverSide: true,
                                paging: true,
                                ajax: "{{ route('admin-soal.materi.materi.index') }}",
                                columns: [
                            ...
                            $('body').on('click', '.edit-data', function () {
                                ...
                                $.get("{{ route('admin-soal.materi.materi.index') }}" +'/' + id_materi + '', function (data) {
                            ...
                            $('#saveDeteleBtn').click(function (e) {
                                ...
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('admin-soal.materi.materi.store') }}"+'/'+id_materi,
                                    success: function (data) {
                                        table.draw();
