                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="importForm" method="POST" name="importForm" class="form-horizontal" action="{{ route('admin-soal.tryout.import') }}" enctype="multipart/form-data">
                                        @csrf
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="theForm" name="theForm" class="form-horizontal">
                                        <input type="hidden" name="id_soal_tryout" id="id_soal_tryout">

                                        <div class="form-group">
                                            <label for="id_label_soal_tryout" class="control-label">Label Soal</label>
                                            <select name="id_label_soal_tryout" id="id_label_soal_tryout" class="form-control">
                                                <option value="" disabled selected>Pilih</option>
                                                @foreach ($label_soal_tryout as $key => $value)
                    ...
                    <div class="modal fade" id="theDeleteModal" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="id_soal_tryout" id="id_soal_tryout_delete">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            var table = $('#dataTableExample').DataTable({
                                ...
                                serverSide: true,
                                paging: true,
                                ajax: "{{ route('admin-soal.tryout.soal.index') }}",
                                columns: [
                            ...
                            $('body').on('click', '.edit-data', function () {
                                var id_soal_tryout = $(this).data('id');
                                $.get("{{ route('admin-soal.tryout.soal.index') }}" +'/' + id_soal_tryout + '', function (data) {
                            ...
                            $('body').on('click', '.delete-data', function () {
                                ...
                                $.get("{{ route('admin-soal.tryout.soal.index') }}" +'/' + id_soal_tryout + '', function (data) {
                                    ...
                                    $('#id_soal_tryout_delete').val(data.id_soal_tryout);
                            ...
                            $('#saveBtn').click(function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ route('admin-soal.tryout.soal.store') }}",
                                    type: "POST",
                                    dataType: 'json',
                            ...
                            $('#saveDeteleBtn').click(function (e) {
                                var id_soal_tryout = $('#id_soal_tryout_delete').val();
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('admin-soal.tryout.soal.store') }}"+'/'+id_soal_tryout,
                                    success: function (data) {
                                        table.draw();
                            ...
                            $('select[name="id_jenis_soal"]').on('change', function() {
                                ...
                                if(id_jenis_soal) {
                                    $.ajax({
                                        url: "/admin-soal/data/get-sub-jenis-soal/"+id_jenis_soal+"",
                                        type: "GET",
                                        dataType: "json",
                                        success:function(data) {
                                            $('select[name="id_sub_jenis_soal"]').empty();
