                                ...
                                <div class="modal-body">
                                    <form id="theForm" name="theForm" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="testimoni" class="form-control" id="testimoni" name="testimoni" required="">
                                        </div>
                    ...
                    <div class="modal fade" id="theDeleteModal" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="id_testimoni" id="id_testimoni_delete">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            $('body').on('click', '.edit-data', function () {
                                var id_testimoni = $(this).data('id');
                                $.get("{{ route('admin.testimoni.index') }}" +'/' + id_testimoni + '', function (data) {
                            ...
                            $('body').on('click', '.delete-data', function () {
                                ...
                                $.get("{{ route('admin.testimoni.index') }}" +'/' + id_testimoni + '', function (data) {
                                    ...
                                    $('#id_testimoni_delete').val(data.id_testimoni);
                            ...
                            $('#saveDeteleBtn').click(function (e) {
                                var id_testimoni = $('#id_testimoni_delete').val();
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('admin.testimoni.store') }}"+'/'+id_testimoni,
                                    success: function (data) {
                                        table.draw();
