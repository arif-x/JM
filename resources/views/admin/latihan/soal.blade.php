          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="card-description">
                    ...
                    <a class="btn btn-primary" href="/excel/latihan.xlsm">Download Format Excel</a>
                </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="importForm" method="POST" name="importForm" class="form-horizontal" action="{{ route('admin.latihan.import') }}" enctype="multipart/form-data">
                                        @csrf
                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            var table = $('#dataTableExample').DataTable({
                                ...
                                serverSide: true,
                                paging: true,
                                ajax: "{{ route('admin.latihan.soal.index') }}",
                                columns: [
                            ...
                            $('body').on('click', '.edit-data', function () {
                                ...
                                $.get("{{ route('admin.latihan.soal.index') }}" +'/' + id_soal + '', function (data) {
                            ...
                            $('#saveBtn').click(function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ route('admin.latihan.soal.store') }}",
                                    type: "POST",
                                    dataType: 'json',
                            ...
                            $('#saveDeteleBtn').click(function (e) {
                                ...
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('admin.latihan.soal.store') }}"+'/'+id_soal,
                                    success: function (data) {
                                        table.draw();
