...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
                <h6 class="card-title">Label Soal Tryout</h6>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="theForm" name="theForm" class="form-horizontal">
                                        <input type="hidden" name="id_label_soal_tryout" id="id_label_soal_tryout">
                    ...
                    <div class="modal fade" id="theDeleteModal" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="id_label_soal_tryout" id="id_label_soal_tryout_delete">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            var table = $('#dataTableExample').DataTable({
                                ...
                                serverSide: true,
                                paging: true,
                                ajax: "{{ route('admin.tryout.label-soal.index') }}",
                                columns: [
                                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                                {data: 'id_label_soal_tryout', name: 'id_label_soal_tryout'},
                            ...
                            $('body').on('click', '.edit-data', function () {
                                var id_label_soal_tryout = $(this).data('id');
                                $.get("{{ route('admin.tryout.label-soal.index') }}" +'/' + id_label_soal_tryout + '', function (data) {
                            ...
                            $('body').on('click', '.delete-data', function () {
                                ...
                                $.get("{{ route('admin.tryout.label-soal.index') }}" +'/' + id_label_soal_tryout + '', function (data) {
                                    ...
                                    $('#id_label_soal_tryout_delete').val(data.id_label_soal_tryout);
                            ...
                            $('#saveBtn').click(function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ route('admin.tryout.label-soal.store') }}",
                                    type: "POST",
                                    dataType: 'json',
                            ...
                            $('#saveDeteleBtn').click(function (e) {
                                var id_label_soal_tryout = $('#id_label_soal_tryout_delete').val();
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('admin.tryout.label-soal.store') }}"+'/'+id_label_soal_tryout,
                                    success: function (data) {
                                        table.draw();
