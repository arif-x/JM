          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="card-description">
                    ...
                    <a class="btn btn-primary" href="/excel/tryout.xlsm">Download Format Excel</a>
                </div>
                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            var table = $('#dataTableExample').DataTable({
                                ...
                                serverSide: true,
                                paging: true,
                                ajax: "{{ route('admin.tryout.soal.index') }}",
                                columns: [
                            ...
                            $('body').on('click', '.edit-data', function () {
                                ...
                                $.get("{{ route('admin.tryout.soal.index') }}" +'/' + id_soal_tryout + '', function (data) {
                            ...
                            $('#saveBtn').click(function (e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ route('admin.tryout.soal.store') }}",
                                    type: "POST",
                                    dataType: 'json',
                            ...
                            $('#saveDeteleBtn').click(function (e) {
                                ...
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ route('admin.tryout.soal.store') }}"+'/'+id_soal_tryout,
                                    success: function (data) {
                                        table.draw();
