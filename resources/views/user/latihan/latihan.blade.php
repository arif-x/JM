    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-3">Pilih Kategori Latihan</h5>
                <p>
                            ...
                            <div class="col-md-3">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-inverse-primary btn-fw ml-0 font-weight-bold col mt-3" data-slug="{{ $soal->slug }}" onclick="latihan(this);" id="kerjakan">Kerjakan</button>
                                    </div>
                                </div>
                            </div>
                            @endforeach
...
<script type="text/javascript">
    function latihan(obj){
        $('#warningModal').modal('show');
        $('#kerjakanBtn').attr('href', '/user/latihan/persiapan/'+$(obj).data('slug'))
        $('#kerjakanInput').val($(obj).data('slug'))
        $('#kerjakanInput').hide()
        $('#formId').attr('action', '/user/latihan/persiapan/'+$(obj).data('slug'));
    }
</script>
