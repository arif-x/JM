				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="mt-4 d-flex flex-column flex-sm-row">
							<a type="button" href="{{ route('user.latihan.kerjakan', $soal->slug) }}" class="btn btn-inverse-primary btn-fw mr-0 mr-sm-1 font-weight-bold mb-2 mb-sm-0"><i class="mdi mdi-file-document-edit-outline icon-md"></i> Kerjakan Sekarang </a>
